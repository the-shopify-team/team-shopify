          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mt-4 sm:mt-6 space-y-4 sm:space-y-6 text-muted-foreground">
              <p className="text-sm sm:text-base leading-relaxed">
                Lorem ipsum dolor sit amet consectetur. Sem ut neque risus convallis at. Nibh
                euismod pellentesque aliquet natoque fringilla. at. Nibh euismod pellentesque
                aliquet natoque fringilla. at. Nibh euismod pellentesque aliquet natoque fringilla.
                at. Nibh euismod pellentesque aliquet natoque fringilla.
              </p>
              <p className="text-sm sm:text-base leading-relaxed">
                Lorem ipsum dolor sit amet consectetur. Sem ut neque risus convallis at. Nibh
                euismod pellentesque aliquet
              </p>
            </div>
          </div>
