        ...
        <div className="text-center mb-20">
          <div className="transition-all duration-1000">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Find e-commerce brands that are scaling fast and need fulfillment support. Ideal for
              3PLs looking to reach operations managers, founders, and logistics leads.
            </p>
          </div>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <CardContent className="relative p-8 text-center">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl mb-6 text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
                  <feature.icon />
                </div>
