  ...
  return (
    <div className='min-h-screen w-full flex justify-center items-center'>
        <div className='space-y-5 py-4 px-8'>
            ...
            <p className="mt-3 mb-4 text-sm md:text-base text-[#939393] text-center">Hurray, your account has been created, let get you started!</p>
            ...
            <Link href="/login" className="block max-w-sm mx-auto">
