...
export default function LoginPage() {
  ...
  return (
    ...
    <p className="mt-3 text-center text-sm"><span className="text-[#111111B2] mr-1">Don’t Have an Account?</span>< Link href="/signup" className="text-[#004A99]">Sign Up</Link></p>
    </div>
  );
}