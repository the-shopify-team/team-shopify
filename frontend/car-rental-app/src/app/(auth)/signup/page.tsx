  ...
  return (
    <div>
      <div className="text-center">
        ...
        <p className="mt-3 mb-4 text-sm md:text-base text-[#939393]">
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    type="text"
                    className="p-5 rounded-2xl placeholder:text-xs"
                    {...field}
                  />
                </FormControl>
      ...
      <p className="mt-3 text-center text-sm">
        <span className="text-[#111111B2] mr-1">Already have an account?</span>
        <Link
          href="/login"
